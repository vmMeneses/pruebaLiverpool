...
data class Record(
   ...
   @SerializedName("dwPromotionInfo")val dwPromotionInfo: DwPromotionInfo,
   @SerializedName("groupType")val groupType: String,
   @SerializedName("isExpressFavoriteStore") val isExpressFavoriteStore: Boolean,
   @SerializedName("isExpressNearByStore")val isExpressNearByStore: Boolean,
   ...
   @SerializedName("plpFlags")val plpFlags: List<Any>,
   ...
   @SerializedName("promotionalGiftMessage")val promotionalGiftMessage: String,
   @SerializedName("seller")val seller: String,
   @SerializedName("skuRepositoryId")val skuRepositoryId: String,
