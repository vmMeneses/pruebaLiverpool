...
data class PlpResults(
    @SerializedName("customUrlParam")val customUrlParam: CustomUrlParam,
    ...
    @SerializedName("refinementGroups")val refinementGroups: List<RefinementGroup>,
    @SerializedName("sortOptions")val sortOptions: List<SortOption>
)